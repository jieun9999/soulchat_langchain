...
# 1. 문서 로드
file_path = "/workspace/hdd/RAG/persona_250311.pdf"
...
# 제목 리스트 정의
titles = [
    "기본 정보", "외모", "평상시 성격", "연애 상대에게는 감성적인 성격","패션 스타일", "직업", "개발 능력", 
...
# 결과 저장
output_csv_path = "/workspace/hdd/RAG/search_results_with_weights2.csv"
